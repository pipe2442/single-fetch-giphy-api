...
<h1>CAT API</h1>
<p>Every time you refresh the page you will see a different cat giphy.</p>
...
# Project Screenshot
![screenshot](https://github.com/pipe2442/single-fetch-giphy-api/blob/main/catapi.PNG)
